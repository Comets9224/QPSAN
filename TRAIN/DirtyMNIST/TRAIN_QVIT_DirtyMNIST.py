# coding=utf-8
"""
Quantum self-attention ViT training script - DirtyMNIST binary classification
...
def setup(args):
    ...
    model = QuantumVisionTransformer(config, args.img_size, zero_head=True, num_classes=num_classes, in_channels=1)  # DirtyMNIST fixed to single channel
