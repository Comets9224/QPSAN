...
def main():
    ...
    parser.add_argument("--model_type", choices=["CosViT-Classical-FER2013"],
                        default="CosViT-Classical-FER2013",
    ...
    parser.add_argument("--learning_rate", default=1e-3, type=float,
                        help="The initial learning rate (default: 1e-3 for COSViT FER2013, optimal from grid search)")
