# coding=utf-8
"""
MLP ViT Training Script - FER2013 Binary Classification

Train MLP attention ViT using MLPVisionTransformer (classical ablation of quantum attention).
MLP attention: ~50-parameter nonlinear scoring function, replacing quantum circuit (5 parameters).
...
from models.MLPVIT import MLPVisionTransformer, MLP_CONFIGS
...
def setup(args):
    ...
    model = MLPVisionTransformer(config, args.img_size, zero_head=True, num_classes=num_classes, in_channels=args.in_channels)
...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-MLP-FER2013"],
                        default="ViT-MLP-FER2013",
