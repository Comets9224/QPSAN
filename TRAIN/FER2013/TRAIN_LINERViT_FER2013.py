# coding=utf-8
"""
Classical ViT Training Script - FER2013 Binary Classification

Train classical attention ViT using VisionTransformer.
...
from models.LINERVIT import VisionTransformer, CONFIGS
...
def setup(args):
    ...
    model = VisionTransformer(config, args.img_size, zero_head=True, num_classes=num_classes, in_channels=args.in_channels)
...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 ...
                                                 "ViT-Tiny", "ViT-Tiny-1",
                                                 "ViT-Classical-FashionMNIST",
                                                 "ViT-Classical-FER2013",
                                                 "LinearViT-Classical-FER2013"],
                        default="LinearViT-Classical-FER2013",
    ...
    parser.add_argument("--learning_rate", default=5e-3, type=float,
                        help="The initial learning rate (default: 5e-3 for LinearViT FER2013, optimal from grid search)")
