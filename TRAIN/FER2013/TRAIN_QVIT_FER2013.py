# coding=utf-8
"""
Quantum Self-Attention ViT Training Script - FER2013 Binary Classification
...
def summarize_and_plot(results, model_name, args):
    ...
    if len(results) == 1:
        ...
        # Build single-run save_data (consistent with ViT format)
        save_data = {
...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-Quantum-Tiny", "ViT-Quantum-Tiny-1",
                                                 "ViT-Quantum-FashionMNIST",
                                                 "ViT-Quantum-FER2013"],
                        default="ViT-Quantum-FER2013",
